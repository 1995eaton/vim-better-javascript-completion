...
let s:maths = ['E', 'LN10', 'LN2', 'LOG2E', 'LOG10E', 'PI', 'SQRT1_2', 'SQRT2',
      \ 'random(', 'abs(', 'acos(', 'asin(', 'atan(', 'ceil(', 'cos(', 'exp(', 'floor(', 'log(', 'round(', 'sin(', 'sqrt(', 'tan(', 'atan2(', 'pow(', 'max(', 'min(', 'imul(']

let s:numbs = ['length', 'name', 'arguments', 'caller', 'prototype', 'MAX_VALUE', 'MIN_VALUE', 'NaN', 'NEGATIVE_INFINITY', 'POSITIVE_INFINITY', 'MAX_SAFE_INTEGER', 'MIN_SAFE_INTEGER', 'EPSILON',
      \ 'isFinite(', 'isInteger(', 'isNaN(', 'isSafeInteger(', 'parseInt(', 'parseFloat(', 'constructor(', 'toString(', 'toLocaleString(', 'valueOf(', 'toFixed(', 'toExponential(', 'toPrecision(']
...
let s:objes = ['length', 'name', 'arguments', 'caller', 'prototype',
      \ 'keys(', 'create(', 'defineProperty(', 'defineProperties(', 'freeze(', 'getPrototypeOf(', 'setPrototypeOf(', 'getOwnPropertyDescriptor(', 'getOwnPropertyNames(', 'is(', 'isExtensible(', 'isFrozen(', 'isSealed(', 'preventExtensions(', 'seal(', 'deliverChangeRecords(', 'getNotifier(', 'observe(', 'unobserve(', 'constructor(', 'toString(', 'toLocaleString(', 'valueOf(', 'hasOwnProperty(', 'isPrototypeOf(', 'propertyIsEnumerable(']

let s:reges = ['length', 'name', 'arguments', 'caller', 'prototype', 'input', 'multiline', 'lastMatch', 'lastParen', 'leftContext', 'rightContext', 'source', 'global', 'ignoreCase', 'multiline', 'lastIndex',
      \ 'constructor(', 'exec(', 'test(', 'toString(', 'compile(']

let s:stris = ['length', 'name', 'arguments', 'caller', 'prototype',
      \ 'constructor(', 'valueOf(', 'toString(', 'charAt(', 'charCodeAt(', 'concat(', 'indexOf(', 'lastIndexOf(', 'localeCompare(', 'match(', 'normalize(', 'replace(', 'search(', 'slice(', 'split(', 'substring(', 'substr(', 'toLowerCase(', 'toLocaleLowerCase(', 'toUpperCase(', 'toLocaleUpperCase(', 'trim(', 'trimLeft(', 'trimRight(', 'link(', 'anchor(', 'fontcolor(', 'fontsize(', 'big(', 'blink(', 'bold(', 'fixed(', 'italics(', 'small(', 'strike(', 'sub(', 'sup(', 'fromCharCode(']
...
let s:nfilter = ['FILTER_ACCEPT', 'FILTER_REJECT', 'FILTER_SKIP', 'SHOW_ALL', 'SHOW_ATTRIBUTE', 'SHOW_CDATA_SECTION', 'SHOW_COMMENT', 'SHOW_DOCUMENT', 'SHOW_DOCUMENT_FRAGMENT', 'SHOW_DOCUMENT_TYPE', 'SHOW_ELEMENT', 'SHOW_ENTITY', 'SHOW_ENTITY_REFERENCE', 'SHOW_NOTATION', 'SHOW_PROCESSING_INSTRUCTION', 'SHOW_TEXT', 'arguments', 'caller', 'length', 'name', 'prototype']
