...
if exists('g:jschromeapis') && g:jschromeapis == 1
...
function! js#CompleteJS(findstart, base)
  if a:findstart
    ...
    if shortcontext =~ '\.$'
      ...
      "Chrome extension API completions -- enable with 'let g:jschromeapis = 1'
      if !exists('values') && g:jschromeapis == 1
